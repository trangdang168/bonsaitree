...
def test_toy_get_ibd_between_segs():
...
def test_toy_group_ibds():
    chrom_ibd_segs_full_dict = \
   {'21':
    [[2, 6, '21', 10867286, 36249317, False, 25.382030999999998],
    [2, 6, '21', 42583395, 48097120, False, 5.513724999999994],
    ...
    grouped = group_ibds(chrom_ibd_segs_full_dict)
    assert(grouped == {'21': 
    ...
    logging.info("Test toy_group_ibds passed")

# test removal orders methods
def test_get_removal_orders():
    chrom_ibd_segs_full_dict = {'21': [
        [2, 6, '21', 10867286, 36249317, False, 25.382030999999998], 
        [2, 6, '21', 42583395, 48097120, False, 5.513724999999994], 
        [4, 2, '21', 36210416, 48097120, False, 11.886703999999995], 
        [2, 5, '21', 37421765, 42425427, False, 5.0036619999999985], 
    ...
    ibd_removal_orders = calculate_removal_orders(chrom_ibd_segs_full_dict, indept_gt_set1, indept_gt_set2)
